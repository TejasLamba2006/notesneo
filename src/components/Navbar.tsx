      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-10">
            <Link
              to="/"
              className={`nav-link font-semibold text-gray-900 dark:text-gray-100 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors text-base ${isActive(
                "/"
              )}`}
            >
              Home
            ...
            <Link
              to="/favorites"
              className={`nav-link font-semibold text-gray-900 dark:text-gray-100 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors text-base flex items-center gap-1 ${isActive(
                "/favorites"
              )}`}
            >
      ...
      {isOpen && (
        <div className="md:hidden bg-white dark:bg-gray-800 shadow-lg rounded-lg px-4 py-6 space-y-4">
          <div className="space-y-3">
            ...
            <Link
              to="/notes"
              className={`mobile-nav-link ${isActive("/notes")}`}
              onClick={closeMenu}
            >
              Notes
            </Link>
            ...
            <Link
              to="/login"
              className="mobile-nav-link bg-indigo-600 text-white"
              onClick={closeMenu}
            >
              Login
            </Link>
